...
def get_all_political_party_by_id_(id_):
...
@political_party_blueprints.route("/political_party/<string:id_>", methods=['PATCH'])
...
@political_party_blueprints.route("/political_party/<string:id_>", methods=['DELETE'])
